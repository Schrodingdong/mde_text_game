 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.BedroomImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.BedroomImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.BedroomImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.BedroomImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.BedroomImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BedroomImpl extends MinimalEObjectImpl.Container implements Bedroom {
	...
	protected EClass eStaticClass() {
		return GameEntityPackage.Literals.BEDROOM;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, GameEntityPackage.BEDROOM__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.BEDROOM__START, oldStart, start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.BEDROOM__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					GameEntityPackage.BEDROOM__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.BEDROOM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GameEntityPackage.BEDROOM__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GameEntityPackage.BEDROOM__ITEMS:
			return getItems();
		case GameEntityPackage.BEDROOM__START:
			return isStart();
		case GameEntityPackage.BEDROOM__EXIT:
			return isExit();
		case GameEntityPackage.BEDROOM__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case GameEntityPackage.BEDROOM__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GameEntityPackage.BEDROOM___ROOM_LOCATION_INFO:
