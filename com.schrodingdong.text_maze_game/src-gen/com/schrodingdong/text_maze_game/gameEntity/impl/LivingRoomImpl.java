 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.LivingRoomImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.LivingRoomImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.LivingRoomImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.LivingRoomImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.LivingRoomImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LivingRoomImpl extends MinimalEObjectImpl.Container implements LivingRoom {
	...
	protected EClass eStaticClass() {
		return GameEntityPackage.Literals.LIVING_ROOM;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, GameEntityPackage.LIVING_ROOM__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.LIVING_ROOM__START, oldStart,
					start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.LIVING_ROOM__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					GameEntityPackage.LIVING_ROOM__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.LIVING_ROOM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GameEntityPackage.LIVING_ROOM__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GameEntityPackage.LIVING_ROOM__ITEMS:
			return getItems();
		case GameEntityPackage.LIVING_ROOM__START:
			return isStart();
		case GameEntityPackage.LIVING_ROOM__EXIT:
			return isExit();
		case GameEntityPackage.LIVING_ROOM__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case GameEntityPackage.LIVING_ROOM__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GameEntityPackage.LIVING_ROOM___ROOM_LOCATION_INFO:
