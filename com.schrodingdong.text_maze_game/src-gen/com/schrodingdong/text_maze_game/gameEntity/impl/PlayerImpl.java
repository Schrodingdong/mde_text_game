 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.PlayerImpl#getCurrRoom <em>Curr Room</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.PlayerImpl#getKey <em>Key</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.PlayerImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlayerImpl extends MinimalEObjectImpl.Container implements Player {
	...
	protected EClass eStaticClass() {
		return GameEntityPackage.Literals.PLAYER;
	}
		...
		if (currRoom != null && currRoom.eIsProxy()) {
			...
			if (currRoom != oldCurrRoom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GameEntityPackage.PLAYER__CURR_ROOM,
	...
	public void setCurrRoom(Room newCurrRoom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.PLAYER__CURR_ROOM, oldCurrRoom,
					currRoom));
	}
	...
	public Key getKey() {
		if (key != null && key.eIsProxy()) {
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GameEntityPackage.PLAYER__KEY, oldKey,
							key));
			}
		}
		return key;
	...
	public void setKey(Key newKey) {
		...
		key = newKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.PLAYER__KEY, oldKey, key));
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectResolvingEList<Item>(Item.class, this, GameEntityPackage.PLAYER__ITEMS);
		}
		return items;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GameEntityPackage.PLAYER__CURR_ROOM:
			if (resolve)
				return getCurrRoom();
			return basicGetCurrRoom();
		case GameEntityPackage.PLAYER__KEY:
			if (resolve)
				return getKey();
			return basicGetKey();
		case GameEntityPackage.PLAYER__ITEMS:
			return getItems();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GameEntityPackage.PLAYER___PICK_ITEMS:
			pickItems();
			return null;
		case GameEntityPackage.PLAYER___MOVE__ROOM:
			move((Room) arguments.get(0));
			return null;
		case GameEntityPackage.PLAYER___USE_KEY:
			return useKey();
		case GameEntityPackage.PLAYER___GET_NEIGHBOORING_ROOM_MAP:
