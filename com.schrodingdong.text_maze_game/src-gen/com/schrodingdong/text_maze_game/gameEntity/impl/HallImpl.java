 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.HallImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.HallImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.HallImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.HallImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.HallImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HallImpl extends MinimalEObjectImpl.Container implements Hall {
	...
	protected EClass eStaticClass() {
		return GameEntityPackage.Literals.HALL;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, GameEntityPackage.HALL__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.HALL__START, oldStart, start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.HALL__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					GameEntityPackage.HALL__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.HALL__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GameEntityPackage.HALL__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GameEntityPackage.HALL__ITEMS:
			return getItems();
		case GameEntityPackage.HALL__START:
			return isStart();
		case GameEntityPackage.HALL__EXIT:
			return isExit();
		case GameEntityPackage.HALL__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case GameEntityPackage.HALL__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GameEntityPackage.HALL___ROOM_LOCATION_INFO:
