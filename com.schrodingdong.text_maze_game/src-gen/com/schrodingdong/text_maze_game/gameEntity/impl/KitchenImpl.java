 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.KitchenImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.KitchenImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.KitchenImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.KitchenImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.gameEntity.impl.KitchenImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KitchenImpl extends MinimalEObjectImpl.Container implements Kitchen {
	...
	protected EClass eStaticClass() {
		return GameEntityPackage.Literals.KITCHEN;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, GameEntityPackage.KITCHEN__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.KITCHEN__START, oldStart, start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.KITCHEN__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					GameEntityPackage.KITCHEN__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameEntityPackage.KITCHEN__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GameEntityPackage.KITCHEN__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GameEntityPackage.KITCHEN__ITEMS:
			return getItems();
		case GameEntityPackage.KITCHEN__START:
			return isStart();
		case GameEntityPackage.KITCHEN__EXIT:
			return isExit();
		case GameEntityPackage.KITCHEN__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case GameEntityPackage.KITCHEN__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GameEntityPackage.KITCHEN___ROOM_LOCATION_INFO:
