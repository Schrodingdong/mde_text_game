 ...
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.KitchenImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.KitchenImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.KitchenImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.KitchenImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.KitchenImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KitchenImpl extends MinimalEObjectImpl.Container implements Kitchen {
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "Kitchen";
	/**
	...
	protected EClass eStaticClass() {
		return Text_maze_gamePackage.Literals.KITCHEN;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, Text_maze_gamePackage.KITCHEN__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.KITCHEN__START, oldStart,
					start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.KITCHEN__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					Text_maze_gamePackage.KITCHEN__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.KITCHEN__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Text_maze_gamePackage.KITCHEN__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Text_maze_gamePackage.KITCHEN__ITEMS:
			return getItems();
		case Text_maze_gamePackage.KITCHEN__START:
			return isStart();
		case Text_maze_gamePackage.KITCHEN__EXIT:
			return isExit();
		case Text_maze_gamePackage.KITCHEN__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case Text_maze_gamePackage.KITCHEN__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Text_maze_gamePackage.KITCHEN___GET_NAME:
			return getName();
		case Text_maze_gamePackage.KITCHEN___ROOM_LOCATION_INFO:
