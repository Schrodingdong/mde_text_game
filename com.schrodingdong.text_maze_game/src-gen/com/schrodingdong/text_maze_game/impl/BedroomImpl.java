...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bedroom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.BedroomImpl#getItems <em>Items</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.BedroomImpl#isStart <em>Start</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.BedroomImpl#isExit <em>Exit</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.BedroomImpl#getNeighbooringRooms <em>Neighbooring Rooms</em>}</li>
 *   <li>{@link com.schrodingdong.text_maze_game.impl.BedroomImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BedroomImpl extends MinimalEObjectImpl.Container implements Bedroom {
	/**
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "Bedroom";
	/**
	...
	protected EClass eStaticClass() {
		return Text_maze_gamePackage.Literals.BEDROOM;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, Text_maze_gamePackage.BEDROOM__ITEMS);
		}
		return items;
	}
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.BEDROOM__START, oldStart,
					start));
	}
	...
	public void setExit(boolean newExit) {
		...
		exit = newExit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.BEDROOM__EXIT, oldExit, exit));
	}
	...
	public EList<Room> getNeighbooringRooms() {
		if (neighbooringRooms == null) {
			neighbooringRooms = new EObjectResolvingEList<Room>(Room.class, this,
					Text_maze_gamePackage.BEDROOM__NEIGHBOORING_ROOMS);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Text_maze_gamePackage.BEDROOM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Text_maze_gamePackage.BEDROOM__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Text_maze_gamePackage.BEDROOM__ITEMS:
			return getItems();
		case Text_maze_gamePackage.BEDROOM__START:
			return isStart();
		case Text_maze_gamePackage.BEDROOM__EXIT:
			return isExit();
		case Text_maze_gamePackage.BEDROOM__NEIGHBOORING_ROOMS:
			return getNeighbooringRooms();
		case Text_maze_gamePackage.BEDROOM__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Text_maze_gamePackage.BEDROOM___GET_NAME:
			return getName();
		case Text_maze_gamePackage.BEDROOM___ROOM_LOCATION_INFO:
