 ...
 * @generated
 */
public class Text_maze_gamePackageImpl extends EPackageImpl implements Text_maze_gamePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.schrodingdong.text_maze_game.Text_maze_gamePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Text_maze_gamePackageImpl() {
		super(eNS_URI, Text_maze_gameFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Text_maze_gamePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Text_maze_gamePackage init() {
		if (isInited)
			return (Text_maze_gamePackage) EPackage.Registry.INSTANCE.getEPackage(Text_maze_gamePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredText_maze_gamePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Text_maze_gamePackageImpl theText_maze_gamePackage = registeredText_maze_gamePackage instanceof Text_maze_gamePackageImpl
				? (Text_maze_gamePackageImpl) registeredText_maze_gamePackage
				: new Text_maze_gamePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theText_maze_gamePackage.createPackageContents();

		// Initialize created meta-data
		theText_maze_gamePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theText_maze_gamePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Text_maze_gamePackage.eNS_URI, theText_maze_gamePackage);
		return theText_maze_gamePackage;
	}
	 ...
	 */
	@Override
	public Text_maze_gameFactory getText_maze_gameFactory() {
		return (Text_maze_gameFactory) getEFactoryInstance();
	}
